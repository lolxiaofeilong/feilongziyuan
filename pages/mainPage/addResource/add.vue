...
                                console.log(res);
								...
								if(me.count==me.imageList.length){
									...
									uni.request({
									 url:"http://139.155.90.219:3000/addStore1"+`?city=${me.city1}&img=${me.img}&placeName=${me.placeName}&name=${me.name}&phone=${me.phone}&address=${me.address}&discrible=${me.discrible}&classic=${me.classic1}&imgs=${imgStr}&video=${me.video}&searchLabel=${me.searchLabel}`,
									 data:{},
									 header:{},
									 success(response) {
											uni.showToast({
