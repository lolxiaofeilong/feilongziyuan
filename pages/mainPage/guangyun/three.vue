		...
		<view class="hello" :style="{fontFamily:fontfamily}">
			...
			<view class="base">
				...
				<view class="item" style="color:skyblue;">
					中间宽：
					<input type="text" v-model="zhongjiankuan">
				</view>
				<view class="item" style="color:skyblue;">
					中间高：
					<input type="text" v-model="zhongjiangao">
				</view>
			</view>
			<view>
			...
			<view class="control">
				<button id="btn" type="primary" @click="btnclick" >手动生成文字</button>
				<button id="btn1" type="primary" @click="btn1click">随机生成文字</button>
				<button id="btn2" type="primary" @click="btn2click">随机生成图标1</button>
				<button id="btn3" type="primary" @click="btn3click">随机生成图标2</button>
			</view>
							...
							<td v-for="(item1, idx1) in item" :key="idx1" :style="{width:kuan,height:gao,transform: ('rotateZ('+tdxuanzhuan+'deg)')}">
								...
								<view class="xx" :style="{margin:waibianju,padding:neibianju,fontSize:fontsize,width:kuan,height:gao,lineHeight:gao}">
									<view class="d1" :style="{background:'rgba('+gexiase.r+','+gexiase.g+','+gexiase.b+','+gexiase.a+')'}">
										<view class="d2" :style="{background:'rgba('+geshangse.r+','+geshangse.g+','+geshangse.b+','+geshangse.a+')',width:zhongjiankuan,height:zhongjiangao}"></view>
	...
	export default {
		...
		data() {
			return {
				...
				d2height: 33,
				fontfamily: "big",
				zhongjiankuan: uni.getStorageSync("zhongjiankuan") || '16px',
				zhongjiangao: uni.getStorageSync("zhongjiangao") || '16px',
				...
				fontcolor:uni.getStorageSync("fontcolor5") ?JSON.parse(uni.getStorageSync("fontcolor5")) :{r: 255,g: 60,b: 90,a: 0.6},
				biaotise:uni.getStorageSync("biaotise5")? JSON.parse(uni.getStorageSync("biaotise5")): {r: 255,g: 100,b: 0,a: 0.6},
				geshangse:uni.getStorageSync("geshangse5")?JSON.parse(uni.getStorageSync("geshangse5")) : {r: 255,g: 0,b: 100,a: 0.6},
				gexiase:uni.getStorageSync("gexiase5")? JSON.parse(uni.getStorageSync("gexiase5")) : {r: 55,g: 100,b: 0,a: 0.6},
				bgcolor:uni.getStorageSync("bgcolor5") ? JSON.parse(uni.getStorageSync("bgcolor5")): {r: 155,g: 0,b: 0,a: 0.6},
			}
		},
		watch: {
			// 将数据保存下来
			...
			zhongjiankuan() {
				uni.setStorageSync("zhongjiankuan", this.zhongjiankuan);
			},
			zhongjiangao() {
				uni.setStorageSync("zhongjiangao", this.zhongjiangao);
			}
