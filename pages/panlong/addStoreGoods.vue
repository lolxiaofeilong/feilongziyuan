	...
	<view class="content">
		<view class="main">
			<view style="flex:1;overflow-y:scroll;" >
				...
				<button type="primary" @click="addStore">添加</button>
			</view>
...
                                console.log(res);
								...
								if(me.count==me.imageList.length){
									...
									uni.request({
									 url:"http://139.155.90.219:3000/addStore2020_Detail"+`?city=${me.city}&img=${me.img}&placeName=${me.placeName}&classic=${me.classic}&name=${me.name}&phone=${me.phone}&address=${me.address}&introduce=${me.jianjie}`,
									 data:{},
									 header:{},
									 success(response) {
											uni.showToast({
